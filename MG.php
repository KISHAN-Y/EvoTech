...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'HECTOR',
		image: './IMAGES/CARMAIN/HECTOR.JPG', 
		title:'MORRIS GARAGES EECTOR', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'ASTOR',
		image: './IMAGES/CARMAIN/ASTOR.JPG', 
		title:'MORRIS GARAGES ASTOR', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'GLOSTER',
		image: './IMAGES/CARMAIN/GLOSTER.JPG', 
		title:'MORRIS GARAGES GLOSTER', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'ZS EV (Electric Vehicle)',
		image: './IMAGES/CARMAIN/ZSEV.JPG', 
		title:'MORRIS GARAGES <BR>ZS EV', 
		description:"This is a description of service here and now let see if it works"
	} ];
