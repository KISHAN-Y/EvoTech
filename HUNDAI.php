...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'VENUE [2019-2022]',
		image: './IMAGES/CARMAIN/VENUE.JPG', 
		title:'HUNDAI VENUE', 
		title2:"lorem for title",
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'ELITE I20 [2019-2020]',
		image: './IMAGES/CARMAIN/I20.JPG', 
		title:'HUDAI ELITE I20', 
		title2:"lorem for title",
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'AURA [2020-2023]',
		image: './IMAGES/CARMAIN/AURA.JPG', 
		title:'HUNDAI AURA',
		title2:"lorem for title", 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'VUNUE N-LINE[2022-2023]',
		image: './IMAGES/CARMAIN/NLINE.JPG', 
		title:'HUNDAI VUNUE N-LINE', 
		title2:"lorem for title",
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'VERNA [2017-2020]',
		image: './IMAGES/CARMAIN/VERNA.JPG', 
		title:'HUNDAI VERNA', 
		title2:"lorem for title",
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'CRETA [2019-2020]',
		image: './IMAGES/CARMAIN/CRETA.JPG', 
		title:'HUNDAI CRETA', 
		title2:"lorem for title",
		description:"This is a description of service here and now let see if it works"
	} ];
