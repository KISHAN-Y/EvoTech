...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'ECOSPORT',
		image: './IMAGES/CARMAIN/ECOSPORT.JPG', 
		title:'FORD ECOSPORT', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'ENDEAVOUR',
		image: './IMAGES/CARMAIN/ENDEAVOUR.JPG', 
		title:'FORD ENDEAVOUR', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'FIGO',
		image: './IMAGES/CARMAIN/FIGO.JPG', 
		title:'FORD FIGO', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'ASPIRE',
		image: './IMAGES/CARMAIN/ASPIRE.JPG', 
		title:'FORD ASPIRE', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'FREESTYLE',
		image: './IMAGES/CARMAIN/FREESTYLE.JPG', 
