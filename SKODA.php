...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'SLAVIA [2022-2023]',
		image: './IMAGES/CARMAIN/SLAVIA.JPG', 
		title:'SKODA SLAVIA', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'OCTAVIA [2017-2021]',
		image: './IMAGES/CARMAIN/OCTAVIA.JPG', 
		title:'SKODA OCTAVIA', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'RAPID',
		image: './IMAGES/CARMAIN/RAPID.JPG', 
		title:'SKODA RAPID', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'KUSHAQ',
		image: './IMAGES/CARMAIN/KUSHAQ.WEBP', 
		title:'SKODA KUSHAQ', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'SUPERB [2016-2020]',
		image: './IMAGES/CARMAIN/SUPERB.JPG', 
		title:'SKODA SUPERB', 
		description:"This is a description of service here and now let see if it works"
	} ];
