...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'RANGE ROVER [2018-2022]',
		image: './IMAGES/CARMAIN/ROVER.JPG', 
		title:'RANGE ROVER', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'DEFENDER',
		image: './IMAGES/CARMAIN/DEFENDER.JPG', 
		title:'DEFENDER', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'RANGE ROVER EVOQUE [2016-2020]',
		image: './IMAGES/CARMAIN/EVOQUE.JPG', 
		title:'RANGE ROVER EVOQUE', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'DISCOVERY SPORT [2018-2020]',
		image: './IMAGES/CARMAIN/DISCOVERY.JPG', 
