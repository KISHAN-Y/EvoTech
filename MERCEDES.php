...
app.controller('mainCtrl', function($scope) {
	$scope.boxes = [{
		name: 'E-CLASS [2017-2021]',
		image: './IMAGES/CARMAIN/E-CLASS.JPG', 
		title:'MERCEDES E-CLASS ', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'C-CLASS',
		image: './IMAGES/CARMAIN/C-CLASS.JPG', 
		title:'MERCEDES C-CLASS ', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'S-CLASS',
		image: './IMAGES/CARMAIN/S-CLASS.JPG', 
		title:'MERCEDES S-CLASS ', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'GLB',
		image: './IMAGES/CARMAIN/GLB.JPG', 
		title:'MERCEDES GLB ', 
		description:"This is a description of service here and now let see if it works"
	},{
		name: 'GLC [2016-2019]',
		image: './IMAGES/CARMAIN/GLC.JPG', 
		title:'MERCEDES GLC', 
		description:"This is a description of service here and now let see if it works"
	}  ];
